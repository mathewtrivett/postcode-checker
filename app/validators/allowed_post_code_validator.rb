...
class AllowedPostCodeValidator < ActiveModel::EachValidator
  ...
  def validate_each(record, attribute, value)
    ...
    record.errors.add(attribute, :not_in_service) unless value.present? && valid_service_area?
  end
